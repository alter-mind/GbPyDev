...
$experience = [
	'exp_name' => ['Job 1', 'Job 2', 'Job 3'],
    'start_time' => ['Start 1', 'Start 2', 'Startt 3'],
    'end_time' => ['End 1', 'End 2', 'End 3']
]
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['exp_name'][2]?> </b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['start_time'][2] ?> - <span class="w3-tag w3-teal w3-round"><?php echo $experience['end_time'][2] ?></span></h6>
          <p>Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['exp_name'][1]?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['start_time'][1] ?> - <?php echo $experience['end_time'][1] ?></h6>
          <p>Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience['exp_name'][0]?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience['start_time'][0] ?> - <?php echo $experience['end_time'][0] ?></h6>
...
###### Скрин изменений по просьбе преподавателя
![[web_tech_intro/sem4/attachments/prtscr.png]]
### Задача 2: 
...
- [HTML-шаблон](https://disk.yandex.ru/d/MhZ9ssjh1lYUGA) резюме с решениями задач №2, 3, 4.  
- [cv-final.txt](https://disk.yandex.ru/d/MhZ9ssjh1lYUGA)  
...
- [Интерактивные онлайн-курсы HTML Academy](https://htmlacademy.ru/tutorial/php/mysql)  
- [Бесплатный веб-хостинг для сайта - Beget](https://beget.com/ru/hosting/free)  
- [Все иконки Font Awesome](https://fontawesome.ru/all-icons/)  
